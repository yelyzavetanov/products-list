  ...
  return (
    <section className='relative mt-16 flex w-full justify-center px-4'>
      <div className='z-0 flex h-full w-full max-w-7xl flex-col-reverse items-center gap-5 pt-14 lg:flex-row lg:justify-between lg:pt-[84px]'>
        ...
        <div className='mx-auto flex aspect-[517/296] h-full w-full max-w-[517px] items-center justify-center max-lg:mt-[-28px]'>
          <Image removeWrapper className='h-full w-full scale-[1.2]' src='/images/iq_graph.svg' alt='Graph' />
        </div>

        <div className='absolute top-0 right-0 left-0 z-[-1] h-full bg-gradient-to-b from-white via-[#EBF4FF] to-white'></div>
      </div>
    </section>
  )
}
